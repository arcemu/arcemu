...
echo "#ifndef SVN_REVISION_H\n" >> src/ascent-shared/svn_revision.h
echo "#define SVN_REVISION_H\n\n" >> src/ascent-shared/svn_revision.h
echo >> src/ascent-shared/svn_revision.h
echo "static const char * BUILD_TAG = \"`cat ascent-tag`\";\n" >> src/ascent-shared/svn_revision.h
echo "static int BUILD_REVISION = $revision;\n\n" >> src/ascent-shared/svn_revision.h
echo >> src/ascent-shared/svn_revision.h
