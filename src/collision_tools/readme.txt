...
After assembly is completed move vmaps folder in your ArcEmu server folder and enable Collision in your arcemu-world.conf

Congrats. You are now done.

For support visit http://www.arcemu.org