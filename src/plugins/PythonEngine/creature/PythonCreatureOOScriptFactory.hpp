...
class PythonCreatureOOScriptFactory
{
public:
	///
	/// Creates an OO Python Creature Script for the specified Creature
	///
	/// Parameters
	///   src    -    The Creature that will use the Script
	///
	/// Return value
	///   An OO Python Creature Script for the specified Creature
	///
