...
#ifndef PYTHON_INSTANCEOOSCRIPT_FACTORY_H
#define PYTHON_INSTANCEOOSCRIPT_FACTORY_H

/// Creates Python OO Instance script instances
class PythonInstanceOOScriptFactory
{
public:
	///
	/// Creates a Python OO Instance Script for the specified Instance
	///
	/// Parameters
