...
class LuaGossip : public Arcemu::Gossip::Script
{
	public:
		...
		~LuaGossip()
		{
			typedef HM_NAMESPACE::HM_HASH_MAP<uint32, LuaGossip*> MapType;
			MapType gMap;
...
class LuaQuest : public QuestScript
{
	public:
		...
		~LuaQuest()
		{
			typedef HM_NAMESPACE::HM_HASH_MAP<uint32, LuaQuest*> QuestType;
...
class LuaInstance : public InstanceScript
{
	public:
		...
		void Destroy()
		{
			...
			typedef HM_NAMESPACE::HM_HASH_MAP<uint32, LuaInstance*> IMAP;
...
QuestScript* CreateLuaQuestScript(uint32 id)
{
	...
	if(pBinding != NULL)
	{
		typedef HM_NAMESPACE::HM_HASH_MAP<uint32, LuaQuest*> QMAP;
...
Arcemu::Gossip::Script* CreateLuaUnitGossipScript(uint32 id)
{
	...
	if(pBinding != NULL)
	{
		typedef HM_NAMESPACE::HM_HASH_MAP<uint32, LuaGossip*> GMAP;
...
{
	Log.Notice("LuaEngineMgr", "Arcemu Lua Engine ( ALE ) %s: Loaded", ARCEMU_ARCH_TXT);
