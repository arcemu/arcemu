...
namespace Arcemu
{
	...
	public:
		...
		//////////////////////////////////////////////////////////////////////////////////
		//bool FindFilesByMask( const char *where, const char *filename, FindFilesResult &r )
		...
		//
		//////////////////////////////////////////////////////////////////////////////////
		static bool FindFilesByMask( const char *where, const char *filename, FindFilesResult &r );
	};
}
