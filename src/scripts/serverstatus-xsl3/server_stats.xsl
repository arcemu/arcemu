...
<xsl:template match="/">
    ...
    <link rel="shortcut icon" href="favicon.ico" />
		...
		<script src="realminfo.js"></script>
	    <link href="css/server_stats.css" rel="stylesheet" type="text/css" />
	</head>
	<body id="top">
		<center><div id="container">
		  <span class="important"><a href="http://www.arcemu.org/"><img src="images/banner.gif" alt="ArcEmu Server Status" width="680" height="90" border="0" /></a></span><br />
		  <div id="links">
        <div align="center"></div>
        <div class="banner">
          <div align="center">Welcome to ArcEmu's server stats page, you may want to change this message :) </div>
        </div>
        <div class="sitelinks" align="center">
        <a href="http://www.arcemu.org/">Home</a> | <a href="http://www.arcemu.org/forums/">Signup</a> | <a href="http://www.arcemu.org/forums/">Forums</a>
        | Other </div>
		</div>
		<xsl:apply-templates/>
