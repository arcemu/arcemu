...
#define prop(name) .property_rw(#name, &lspellentry::name)
		...
		m	.class_<SpellEntry>("SpellEntry")
			prop(Id)
			prop(DispelType)
			prop(MechanicsType)
			prop(Attributes)
		...
		m	.class_decl<lspellentry>("SpellEntry");
		m	.class_<lspellentry>()
...
#undef prop
#define prop(name) .property_rw(#name, &AISpell_InteractionData::name)
		m	.class_<AISpell_InteractionData>("AISpell_InteractData")
			.constructor< void(*)() >()
			prop(soundId)
			prop(chat_type)
			prop(lang_type)
			prop(sendtxt);
#undef prop
		m	.class_<AISpell_RandomData>("AISpell_RandomData")
			.constructor< void(*)() >()
			.property_rw("lower_interval",&AISpell_RandomData::getInterval<0>, &AISpell_RandomData::setInterval<0>)
			.property_rw("upper_interval", &AISpell_RandomData::getInterval<1>, &AISpell_RandomData::setInterval<1>)
			.property_rw("lower_facing", &AISpell_RandomData::getFacing<0>, &AISpell_RandomData::setFacing<0>)
			.property_rw("upper_facing", &AISpell_RandomData::getFacing<1>, &AISpell_RandomData::setFacing<1> )
			.property_rw("lower_radius", &AISpell_RandomData::getRadius<0>, &AISpell_RandomData::setRadius<0> )
			.property_rw("upper_radius", &AISpell_RandomData::getRadius<1>, &AISpell_RandomData::setRadius<1> );
	}
}
