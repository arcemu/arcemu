...
public:
    ...
    CABALACOLYTEAI(Creature* pCreature) : CreatureAIScript(pCreature)
    {
		...
		spells[0].info = sSpellStore.LookupEntry(SHADOW_PROTECTION);
...
public:
    ...
    CABALDEATHSWORNAI(Creature* pCreature) : CreatureAIScript(pCreature)
    {
		...
		spells[0].info = sSpellStore.LookupEntry(SHADOW_CLEAVE);
		spells[0].targettype = TARGET_VARIOUS;
		spells[0].instant = true;
		spells[0].perctrigger = 9.0f;
		spells[0].attackstoptimer = 1000;

		spells[1].info = sSpellStore.LookupEntry(KNOCKBACK);
		spells[1].targettype = TARGET_VARIOUS;
		spells[1].instant = true;
		spells[1].perctrigger = 6.0f;
		spells[1].attackstoptimer = 1000;

		spells[2].info = sSpellStore.LookupEntry(BLACK_CLEAVE);
...
public:
    ...
    CABALFANATICAI(Creature* pCreature) : CreatureAIScript(pCreature)
    {
		...
		spells[0].info = sSpellStore.LookupEntry(FIXATE);
...
public:
    ...
    CABALSHADOWPRIESTAI(Creature* pCreature) : CreatureAIScript(pCreature)
    {
		...
		spells[0].info = sSpellStore.LookupEntry(MIND_FLAY);
		spells[0].targettype = TARGET_ATTACKING;
...
public:
    ...
    CABALSPELLBINDERAI(Creature* pCreature) : CreatureAIScript(pCreature)
    {
		...
		spells[1].info = sSpellStore.LookupEntry(EARTH_SHOCK);
		spells[1].targettype = TARGET_ATTACKING;
		spells[1].instant = true;
		spells[1].perctrigger = 10.0f;
		spells[1].attackstoptimer = 1000;
...
public:
    ...
    CABALWARLOCKAI(Creature* pCreature) : CreatureAIScript(pCreature)
    {
		...
		spells[1].info = sSpellStore.LookupEntry(SEED_OF_CORRUPTION);
		spells[1].targettype = TARGET_ATTACKING;
		spells[1].instant = false;
...
public:
    ...
    CABALZEALOTAI(Creature* pCreature) : CreatureAIScript(pCreature)
    {
		...
		spells[1].info = sSpellStore.LookupEntry(TRANSFROMATION);
		spells[1].targettype = TARGET_SELF;
		spells[1].instant = true;
...
public:
    ...
    CABALRITUALISTAI(Creature* pCreature) : CreatureAIScript(pCreature)
    {
		...
		spells[2].info = sSpellStore.LookupEntry(ADDLE_HUMANOID);
		spells[2].targettype = TARGET_ATTACKING;
		spells[2].instant = false;
		spells[2].perctrigger = 7.0f;
		spells[2].attackstoptimer = 1000;

		spells[3].info = sSpellStore.LookupEntry(FIRE_BLAST);
		spells[3].targettype = TARGET_ATTACKING;
		spells[3].instant = true;
		spells[3].perctrigger = 9.0f;
		spells[3].attackstoptimer = 1000;

		spells[4].info = sSpellStore.LookupEntry(FLAME_BUFFET);
...
public:
    ...
    FELOVERSEERAI(Creature* pCreature) : CreatureAIScript(pCreature)
    {
		...
		spells[1].info = sSpellStore.LookupEntry(CHARGE_OVERSEER);
		spells[1].targettype = TARGET_ATTACKING;
		spells[1].instant = true;
		spells[1].perctrigger = 5.0f;
		spells[1].attackstoptimer = 1000;

		spells[2].info = sSpellStore.LookupEntry(HEAL_OVERSEER);
		...
		spells[4].info = sSpellStore.LookupEntry(UPPERCUT);
...
public:
    ...
    MALICIOUSINSTRUCTORAI(Creature* pCreature) : CreatureAIScript(pCreature)
    {
		...
		spells[0].info = sSpellStore.LookupEntry(SHADOW_NOVA);
		spells[0].targettype = TARGET_VARIOUS;
		spells[0].instant = true;
		spells[0].perctrigger = 12.0f;
		spells[0].attackstoptimer = 1000;

		spells[1].info = sSpellStore.LookupEntry(MARK_OF_MALICE);
		spells[1].targettype = TARGET_ATTACKING;
		spells[1].instant = false;
...
public:
    ...
    AMBASSADORHELLMAWAI(Creature* pCreature) : CreatureAIScript(pCreature)
    {
		...
		spells[0].info = sSpellStore.LookupEntry(CORROSIVE_ACID);
		spells[0].targettype = TARGET_VARIOUS;
		spells[0].instant = false;
		spells[0].perctrigger = 8.0f;
		spells[0].attackstoptimer = 1000;
...
public:
    ...
    BLACKHEARTTHEINCITERAI(Creature* pCreature) : CreatureAIScript(pCreature)
    {
		...
		spells[0].info = sSpellStore.LookupEntry(INCITE_CHAOS);
		spells[0].targettype = TARGET_ATTACKING;
		spells[0].instant = true;
		spells[0].perctrigger = 8.0f;
		spells[0].attackstoptimer = 1000;
		...
		spells[2].info = sSpellStore.LookupEntry(WAR_STOMP);
		spells[2].targettype = TARGET_VARIOUS; 
		spells[2].instant = true;
		spells[2].perctrigger = 8.0f;
		spells[2].attackstoptimer = 1000;

		spells[3].info = sSpellStore.LookupEntry(AOE_KNOCKBACK);
...
public:
    ...
    GRANDMASTERVORPILAI(Creature* pCreature) : CreatureAIScript(pCreature)
    {
		...
		spells[1].info = sSpellStore.LookupEntry(TELEPORT_PARTY);
		spells[1].targettype = TARGET_ATTACKING;
		spells[1].instant = true;
		spells[1].perctrigger = 0.0f;
		spells[1].attackstoptimer = 1000;

		spells[2].info = sSpellStore.LookupEntry(RAIN_OF_FIRE);
		spells[2].targettype = TARGET_DESTINATION; 
		spells[2].instant = false;
		spells[2].perctrigger = 0.0f;
		spells[2].attackstoptimer = 7000;

		spells[3].info = sSpellStore.LookupEntry(VOID_PORTAL_VISUAL);
...
public:
    ...
    MURMURAI(Creature* pCreature) : CreatureAIScript(pCreature)
    {
		...
		spells[0].info = sSpellStore.LookupEntry(SONIC_BOOM);
		spells[0].targettype = TARGET_VARIOUS;
		spells[0].instant = true;
		spells[0].perctrigger = 7.0f;
		spells[0].attackstoptimer = 1000;
...
*/
		...
		spells[4].info = sSpellStore.LookupEntry(THUNDERING_STORM);
		spells[4].targettype = TARGET_VARIOUS;
		spells[4].instant = true;
