...
DELETE FROM `creature_waypoints` WHERE `spawnid` BETWEEN '500000' AND '500028';
...
DELETE FROM `gameobject_spawns` WHERE `id` BETWEEN '500000' AND '500114';

/* REMOVE CREATURE FORMATIONS */
DELETE FROM `creature_formations` WHERE `spawn_id` BETWEEN '500000' AND '500028';
