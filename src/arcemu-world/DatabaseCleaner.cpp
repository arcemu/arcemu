...
/* This will need examination every time a table index or key entry is added/changed to prevent unneeded rows. */
 ...
 {
        Log.Notice("DatabaseCleaner", "Stage 1 of 3: Cleaning World");
        CleanWorld();
 
        Log.Notice("DatabaseCleaner", "Stage 2 of 3: Cleaning Characters");
        CleanCharacters();
 
        Log.Notice("DatabaseCleaner", "Stage 3 of 3: Optimizing Tables");
        Optimize();
 }
