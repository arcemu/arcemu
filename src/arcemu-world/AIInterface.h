...
enum WPMovementFlags // for waypoints, 0 and any other flag is WALK
{
	WPMOVEMENTFLAG_WALK		= 0,
	WPMOVEMENTFLAG_RUN		= 256,
	WPMOVEMENTFLAG_FLY		= 768,
};
