...
enum WorldStringsEntries
{
    ...
    WORLDSTRING_UNDERSTANDI                     = 24,   //I understand, continue.
    ...
    WORLDSTRING_MUST_HAVE_UNKNOWNI_TEM_TO_PASS  = 36,   //You must have the item, UNKNOWN to pass through here.
    ...
    WORLDSTRING_THIRTY_MINUTES_LEFT_UNTIL_BATTLE  = 47, //Thirty seconds until the battle for %s begins!
    WORLDSTRING_FIFTEEN_MINUTES_LEFT_UNTIL_BATTLE = 48, //Fifteen seconds until the battle for %s begins!
