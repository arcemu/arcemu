...
enum AuraInterruptFlags
{
    ...
    AURA_INTERRUPT_ON_DISMOUNT					= 0x40, // Remove on dismounting
    AURA_INTERRUPT_ON_ENTER_WATER				= 0x80, // Remove when entering water
    AURA_INTERRUPT_ON_LEAVE_WATER				= 0x100, // Remove when leaving water, could be AURA_INTERRUPT_ON_LEAVE_CURRENT_SURFACE
    AURA_INTERRUPT_ON_UNUSED2					= 0x200, // Something to do with sheath state
    AURA_INTERRUPT_ON_UNK4						= 0x400, // On gossip NPC?
    ...
    AURA_INTERRUPT_ON_LEAVE_AREA				= 0x80000, // Remove on leaving zone or being teleported
    AURA_INTERRUPT_ON_INVINCIBLE				= 0x100000,
    AURA_INTERRUPT_ON_STEALTH					= 0x200000,
    AURA_INTERRUPT_ON_UNK8						= 0x400000,
    AURA_INTERRUPT_ON_PVP_ENTER					= 0x800000, // Remove on getting PvP flag
