...
void CommandTableStorage::Init()
{
	...
	static ChatCommand questCommandTable[] =
	{
		...
		{ "showlog",   '2', &ChatHandler::HandleQuestShowLogCommand,   "Lists the quests for the selected player",                  NULL, 0, 0, 0 },
		{ "assist",    '2', &ChatHandler::HandleQuestRequirementCommand,"Gives player selected requirements for quest <id> <type>", NULL, 0, 0, 0 },
		{ NULL,        '0', NULL,                                      "",                                                          NULL, 0, 0, 0 }
	};
	...
	static ChatCommand characterCommandTable[] =
	{
		...
		{ "removeitemslot",      'm', &ChatHandler::HandleRemoveItemSlotCommand,   "Removes item by location in container.",                                                                            NULL, 0, 0, 0 },
		{ "clearinventory",      'z', &ChatHandler::HandleClearInventoryCommand,   "Clears a players inventory. Type 'yes' after the command to clear you own. ",                                       NULL, 0, 0, 0 },
