...
void WorldSession::SendCharterRequest(Creature* pCreature)
{
			...
			pCreature->GetEntry()==18897 || pCreature->GetEntry()==19856 || pCreature->GetEntry()==sWorld.m_CustomCharterGiver ) )
	{
		...
		static const uint8 tdata[73] = { 0x03, 0x01, 0x00, 0x00, 0x00, 0x08, 0x5C, 0x00, 0x00, 0x21, 0x3F, 0x00, 0x00, (uint8)(ARENA_TEAM_CHARTER_2v2_COST&0xff), (uint8)((ARENA_TEAM_CHARTER_2v2_COST>>8)&0xff), (uint8)((ARENA_TEAM_CHARTER_2v2_COST>>16)&0xff), (uint8)((ARENA_TEAM_CHARTER_2v2_COST>>24)&0xff), 0x01, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x09, 0x5C, 0x00, 0x00, 0x21, 0x3F, 0x00, 0x00, (uint8)(ARENA_TEAM_CHARTER_3v3_COST&0xff), (uint8)((ARENA_TEAM_CHARTER_3v3_COST>>8)&0xff), (uint8)((ARENA_TEAM_CHARTER_3v3_COST>>16)&0xff), (uint8)((ARENA_TEAM_CHARTER_3v3_COST>>24)&0xff), 0x01, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x03, 0x00, 0x00, 0x00, 0x0A, 0x5C, 0x00, 0x00, 0x21, 0x3F, 0x00, 0x00, (uint8)(ARENA_TEAM_CHARTER_5v5_COST&0xff), (uint8)((ARENA_TEAM_CHARTER_5v5_COST>>8)&0xff), (uint8)((ARENA_TEAM_CHARTER_5v5_COST>>16)&0xff), (uint8)((ARENA_TEAM_CHARTER_5v5_COST>>24)&0xff), 0x01, 0x00, 0x00, 0x00, 0x04, 0x00, 0x00, 0x00 };
		data << pCreature->GetGUID();
