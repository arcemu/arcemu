...
enum Opcodes {
    ...
    SMSG_UPDATE_AURA_DURATION_OBSOLETE              = 0x137,	// not used in client
    ...
    CMSG_SET_TARGET_OBSOLETE                        = 0x13E,	// not used in client
    ...
    CMSG_EQUIPMENT_SET_USE                          = 0x4CB,	/// TODO: investigate, CMSG, lua: UseEquipmentSet
    SMSG_EQUIPMENT_SET_USE_RESULT                   = 0x4CC,	/// TODO: investigate, SMSG, UseEquipmentSetResult?
