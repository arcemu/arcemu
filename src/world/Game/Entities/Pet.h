...
class SERVER_DECL Pet : public Creature
{
	...
	public:
		...
		bool CreateAsSummon(uint32 entry, Creature* created_from_creature, Player* owner, SpellEntry* created_by_spell, uint32 type, uint32 expiretime, LocationVector* Vec = NULL, bool dismiss_old_pet = true);
