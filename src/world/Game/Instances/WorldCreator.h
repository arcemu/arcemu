...
enum Maps
{
	...
	MAP_SHADOW_LABYRINTH      = 555,
	MAP_SETHEK_HALLS          = 556,
	MAP_MANA_TOMBS            = 557,
	MAP_AUCHENAI_CRYPTS       = 558,
	MAP_ARENA_NAGRAND         = 559,
	MAP_ARENA_BLADES_EDGE     = 562,
	MAP_NORTHREND             = 571,
	MAP_ARENA_RUINS_OF_LORDAERON = 572
};
...
typedef HM_NAMESPACE::HM_HASH_MAP<uint32, Instance*> InstanceMap;
