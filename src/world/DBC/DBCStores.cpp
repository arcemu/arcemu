...
const char* LFGDungeonEntryformat = "nsxxxxxxxxxxxxxxxxiiiiiiixixxixixxxxxxxxxxxxxxxxx";
...
bool LoadDBCs()
{
	...
	LOAD_DBC("DBC/LFGDungeons.dbc", LFGDungeonEntryformat, true, dbcLFGDungeon, true);
