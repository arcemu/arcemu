...
void CommandTableStorage::Init()
{
	...
	static ChatCommand debugCommandTable[] =
	{
		...
		{ "leap",                'd', &ChatHandler::HandleLeapCommand,             ".leap <horizontal> <vertical> (<direction>) - Knocks you back.",                                                                  NULL, 0, 0, 0 },
	...
	static ChatCommand GameObjectCommandTable[] =
	{
		...
		{ "artkit",       'g', &ChatHandler::HandleGOArtkit,       "Sets the gameobject's artkit", NULL, 0, 0, 0 },
		{ NULL,           '0', NULL,                               "",                                         NULL, 0, 0, 0 }
	};
	...
	static ChatCommand NPCCommandTable[] =
	{
		...
		{ "npcfollow",        'm', &ChatHandler::HandleNpcFollowCommand,      "Sets npc to follow you. Parameters: [angle] [distance]",                                                                                                                  NULL, 0, 0, 0 },
	...
	static ChatCommand CheatCommandTable[] =
	{
		...
		{ "area",        'm', &ChatHandler::HandleAreaCheatCommand,        "Ignores spell area requirements.",                NULL, 0, 0, 0 },
