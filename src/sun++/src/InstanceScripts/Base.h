...
protected:
	enum					TargetFilter {TargetFilter_None=0, TargetFilter_Closest=1<<0, TargetFilter_Friendly=1<<1, TargetFilter_NotCurrent=1<<2, TargetFilter_Wounded=1<<3, TargetFilter_SecondMostHated=1<<4, TargetFilter_Aggroed=1<<5};
