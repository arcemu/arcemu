...
class DragonTurtleAI : public MoonScriptCreatureAI
{
	...
	DragonTurtleAI(Creature *pCreature) : MoonScriptCreatureAI(pCreature)
	{
		...
		AddSpell(DRAGON_TURTLE_WATER_SPIT, Target_Current, 8, 2.5, 20);		// Random?
	}
};
...
class MutantWarHoundAI : public MoonScriptCreatureAI
{
	...
	void OnDied(Unit *pKiller)
	{
		...
		if (pAura != NULL)
		{
			pAura->Init(dbcSpell.LookupEntry(MUTANT_WAR_HOUND_CLOUD_OF_DISEASE), 20000, _unit, _unit);	// core prevents from dmging targets =/
			_unit->AddAura(pAura);
		}
	}
};
...
class ShadowmoonRidingHoundAI : public MoonScriptCreatureAI
{
	...
	{
		AddSpell(SHADOWMOON_RIDING_HOUND_CARNIVOROUS_BITE, Target_Current, 10, 0, 20);
...
class SisterOfPleasureAI : public MoonScriptCreatureAI
{
	...
	{
		AddSpell(SISTER_OF_PLEASURE_GREATER_HEAL, Target_Self, 10, 2, 45);
...
class SisterOfPainAI : public MoonScriptCreatureAI
{
	...
	{
		AddSpell(SISTER_OF_PAIN_LASH_OF_PAIN, Target_Current, 10, 0, 25);
...
class IllidariHeartseekerAI : public MoonScriptCreatureAI
{
	...
	IllidariHeartseekerAI(Creature *pCreature) : MoonScriptCreatureAI(pCreature)
	{
		...
		AddSpell(ILLIDARI_HEARTSEEKER_RAPID_SHOT, Target_Self, 7, 0, 40, 0, 30);
...
class IllidariFearbringerAI : public MoonScriptCreatureAI
{
	...
	{
		AddSpell(ILLIDARI_FEARBRINGER_ILLIDARI_FLAMES, Target_Current, 8, 2, 25);
...
class IllidariCenturionAI : public MoonScriptCreatureAI
{
	...
	{
		AddSpell(ILLIDARI_CENTURION_CLEAVE, Target_Current, 10, 0, 20);
...
class IllidariBoneslicerAI : public MoonScriptCreatureAI
{
	...
	IllidariBoneslicerAI(Creature *pCreature) : MoonScriptCreatureAI(pCreature)
	{
		...
		AddSpellFunc(&SpellFunc_Gouge, Target_Current, 7, 0, 25);
...
class HungeringSoulFragmentAI : public MoonScriptCreatureAI
{
	...
	{
		ApplyAura(HUNGERING_SOUL_FRAGMENT_CONSUMING_STRIKES);		// beg core to hook OnHit event
	}
};
...
class ShadowyConstructAI : public MoonScriptCreatureAI
{
	...
	{
		AddSpell(SHADOWY_CONSTRUCT_ATROPHY, Target_Current, 10, 0, 45);
	}
};
...
class VangefulSpiritAI : public MoonScriptCreatureAI
{
	...
	VangefulSpiritAI(Creature *pCreature) : MoonScriptCreatureAI(pCreature)
	{
		...
		AddSpell(VANGEFUL_SPIRIT_SPIRIT_STRIKE, Target_Current, 9, 0, 15);
...
class WrathboneFlayerAI : public MoonScriptCreatureAI
{
	...
	{
		AddSpell(WRATHBONE_FLAYER_CLEAVE, Target_Current, 10, 0, 15);
		AddSpell(WRATHBONE_FLAYER_IGNORED, Target_Current, 7, 0, 25);		// Current or random?
	}
};
