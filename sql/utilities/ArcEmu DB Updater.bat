...
ECHO [Importing] 2817_recallorientation.sql
mysql -h %server% --user=%user% --password=%pass% --port=%port% %wdb% --force < ..\world_updates\2817_recallorientation.sql

ECHO [Importing] 2828_spawns_phase.sql
mysql -h %server% --user=%user% --password=%pass% --port=%port% %wdb% --force < ..\world_updates\2828_spawns_phase.sql
...
ECHO [Importing] 2828_characters_phase.sql
mysql -h %server% --user=%user% --password=%pass% --port=%port% %chr% < ..\character_updates\2828_characters_phase.sql
...
ECHO [Importing] 2391_accounts_banned.sql
mysql -h %server% --user=%user% --password=%pass% --port=%port% %logon% < ..\logon_updates\2391_accounts_banned.sql
