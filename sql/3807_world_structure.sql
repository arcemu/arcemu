...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='AI System';/*	AI Rewrite ai_agent structureDROP TABLE IF EXISTS `ai_agents`;CREATE TABLE `ai_agents` (  `ID` int(11) NOT NULL AUTO_INCREMENT,  `entry` int(6) DEFAULT NULL COMMENT 'The id of the creature.',  `creature_name` varchar(255) DEFAULT NULL COMMENT 'Stores a given creature name. No internal use, purely for easier recognition of data.',  `difficulty` tinyint(2) NOT NULL DEFAULT '0' COMMENT 'The difficulty in which the spell will be cast in only. For dungeons, 0 is Normal, 1 is Heroic.',  `agent_type` tinyint(2) unsigned NOT NULL DEFAULT '3' COMMENT 'The agent type, options are 0 - No Agent, 1 -  Melee Spell Agent, 2 - Ranged Spell Agent, 3 - Normal Spell Agent',  `creature_event` tinyint(2) unsigned NOT NULL DEFAULT '3' COMMENT 'Default is 3 for EVENT_INCOMBAT',  `chance` int(11) unsigned NOT NULL DEFAULT '100' COMMENT 'Percent chance that the spell will be cast, 100 for always, 0 for never.',  `maxcount` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT 'The number of times this spell will be cast.',  `spell_id` int(6) unsigned NOT NULL,  `spell_name` varchar(255) DEFAULT NULL COMMENT 'Stores a given spell name, has no internal use. Purely for easier recognition of data.',  `spelltype` tinyint(2) unsigned NOT NULL DEFAULT '1',  `targettype` tinyint(2) unsigned NOT NULL DEFAULT '3',  `interval` int(11) unsigned NOT NULL,  `attributes` varchar(512) DEFAULT NULL,  PRIMARY KEY (`ID`)) ENGINE=MyISAM  DEFAULT CHARSET=latin1 COMMENT='AI System';*/
