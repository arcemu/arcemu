...
#define ER_FOREIGN_SERVER_EXISTS 1473
#define ER_FOREIGN_SERVER_DOESNT_EXIST 1474
#define ER_ILLEGAL_HA_CREATE_OPTION 1475
#define ER_PARTITION_REQUIRES_VALUES_ERROR 1476
#define ER_PARTITION_WRONG_VALUES_ERROR 1477
#define ER_PARTITION_MAXVALUE_ERROR 1478
#define ER_PARTITION_SUBPARTITION_ERROR 1479
#define ER_PARTITION_SUBPART_MIX_ERROR 1480
#define ER_PARTITION_WRONG_NO_PART_ERROR 1481
#define ER_PARTITION_WRONG_NO_SUBPART_ERROR 1482
#define ER_CONST_EXPR_IN_PARTITION_FUNC_ERROR 1483
#define ER_NO_CONST_EXPR_IN_RANGE_OR_LIST_ERROR 1484
#define ER_FIELD_NOT_FOUND_PART_ERROR 1485
#define ER_LIST_OF_FIELDS_ONLY_IN_HASH_ERROR 1486
#define ER_INCONSISTENT_PARTITION_INFO_ERROR 1487
#define ER_PARTITION_FUNC_NOT_ALLOWED_ERROR 1488
#define ER_PARTITIONS_MUST_BE_DEFINED_ERROR 1489
#define ER_RANGE_NOT_INCREASING_ERROR 1490
#define ER_INCONSISTENT_TYPE_OF_FUNCTIONS_ERROR 1491
#define ER_MULTIPLE_DEF_CONST_IN_LIST_PART_ERROR 1492
#define ER_PARTITION_ENTRY_ERROR 1493
#define ER_MIX_HANDLER_ERROR 1494
#define ER_PARTITION_NOT_DEFINED_ERROR 1495
#define ER_TOO_MANY_PARTITIONS_ERROR 1496
#define ER_SUBPARTITION_ERROR 1497
#define ER_CANT_CREATE_HANDLER_FILE 1498
#define ER_BLOB_FIELD_IN_PART_FUNC_ERROR 1499
#define ER_UNIQUE_KEY_NEED_ALL_FIELDS_IN_PF 1500
#define ER_NO_PARTS_ERROR 1501
#define ER_PARTITION_MGMT_ON_NONPARTITIONED 1502
#define ER_FOREIGN_KEY_ON_PARTITIONED 1503
#define ER_DROP_PARTITION_NON_EXISTENT 1504
#define ER_DROP_LAST_PARTITION 1505
#define ER_COALESCE_ONLY_ON_HASH_PARTITION 1506
#define ER_REORG_HASH_ONLY_ON_SAME_NO 1507
#define ER_REORG_NO_PARAM_ERROR 1508
#define ER_ONLY_ON_RANGE_LIST_PARTITION 1509
#define ER_ADD_PARTITION_SUBPART_ERROR 1510
#define ER_ADD_PARTITION_NO_NEW_PARTITION 1511
#define ER_COALESCE_PARTITION_NO_PARTITION 1512
#define ER_REORG_PARTITION_NOT_EXIST 1513
#define ER_SAME_NAME_PARTITION 1514
#define ER_NO_BINLOG_ERROR 1515
#define ER_CONSECUTIVE_REORG_PARTITIONS 1516
#define ER_REORG_OUTSIDE_RANGE 1517
#define ER_PARTITION_FUNCTION_FAILURE 1518
#define ER_PART_STATE_ERROR 1519
#define ER_LIMITED_PART_RANGE 1520
#define ER_PLUGIN_IS_NOT_LOADED 1521
#define ER_WRONG_VALUE 1522
#define ER_NO_PARTITION_FOR_GIVEN_VALUE 1523
#define ER_FILEGROUP_OPTION_ONLY_ONCE 1524
#define ER_CREATE_FILEGROUP_FAILED 1525
#define ER_DROP_FILEGROUP_FAILED 1526
#define ER_TABLESPACE_AUTO_EXTEND_ERROR 1527
#define ER_WRONG_SIZE_NUMBER 1528
#define ER_SIZE_OVERFLOW_ERROR 1529
#define ER_ALTER_FILEGROUP_FAILED 1530
#define ER_BINLOG_ROW_LOGGING_FAILED 1531
#define ER_BINLOG_ROW_WRONG_TABLE_DEF 1532
#define ER_BINLOG_ROW_RBR_TO_SBR 1533
#define ER_EVENT_ALREADY_EXISTS 1534
#define ER_EVENT_STORE_FAILED 1535
#define ER_EVENT_DOES_NOT_EXIST 1536
#define ER_EVENT_CANT_ALTER 1537
#define ER_EVENT_DROP_FAILED 1538
#define ER_EVENT_INTERVAL_NOT_POSITIVE_OR_TOO_BIG 1539
#define ER_EVENT_ENDS_BEFORE_STARTS 1540
#define ER_EVENT_EXEC_TIME_IN_THE_PAST 1541
#define ER_EVENT_OPEN_TABLE_FAILED 1542
#define ER_EVENT_NEITHER_M_EXPR_NOR_M_AT 1543
#define ER_COL_COUNT_DOESNT_MATCH_CORRUPTED 1544
#define ER_CANNOT_LOAD_FROM_TABLE 1545
#define ER_EVENT_CANNOT_DELETE 1546
#define ER_EVENT_COMPILE_ERROR 1547
#define ER_EVENT_SAME_NAME 1548
#define ER_EVENT_DATA_TOO_LONG 1549
#define ER_DROP_INDEX_FK 1550
#define ER_WARN_DEPRECATED_SYNTAX_WITH_VER 1551
#define ER_CANT_WRITE_LOCK_LOG_TABLE 1552
#define ER_CANT_LOCK_LOG_TABLE 1553
#define ER_FOREIGN_DUPLICATE_KEY 1554
#define ER_COL_COUNT_DOESNT_MATCH_PLEASE_UPDATE 1555
#define ER_TEMP_TABLE_PREVENTS_SWITCH_OUT_OF_RBR 1556
#define ER_STORED_FUNCTION_PREVENTS_SWITCH_BINLOG_FORMAT 1557
#define ER_NDB_CANT_SWITCH_BINLOG_FORMAT 1558
#define ER_PARTITION_NO_TEMPORARY 1559
#define ER_PARTITION_CONST_DOMAIN_ERROR 1560
#define ER_PARTITION_FUNCTION_IS_NOT_ALLOWED 1561
#define ER_DDL_LOG_ERROR 1562
#define ER_NULL_IN_VALUES_LESS_THAN 1563
#define ER_WRONG_PARTITION_NAME 1564
#define ER_CANT_CHANGE_TX_ISOLATION 1565
#define ER_DUP_ENTRY_AUTOINCREMENT_CASE 1566
#define ER_EVENT_MODIFY_QUEUE_ERROR 1567
#define ER_EVENT_SET_VAR_ERROR 1568
#define ER_PARTITION_MERGE_ERROR 1569
#define ER_CANT_ACTIVATE_LOG 1570
#define ER_RBR_NOT_AVAILABLE 1571
#define ER_BASE64_DECODE_ERROR 1572
#define ER_EVENT_RECURSION_FORBIDDEN 1573
#define ER_EVENTS_DB_ERROR 1574
#define ER_ONLY_INTEGERS_ALLOWED 1575
#define ER_UNSUPORTED_LOG_ENGINE 1576
#define ER_BAD_LOG_STATEMENT 1577
#define ER_CANT_RENAME_LOG_TABLE 1578
#define ER_WRONG_PARAMCOUNT_TO_NATIVE_FCT 1579
#define ER_WRONG_PARAMETERS_TO_NATIVE_FCT 1580
#define ER_WRONG_PARAMETERS_TO_STORED_FCT 1581
#define ER_NATIVE_FCT_NAME_COLLISION 1582
#define ER_DUP_ENTRY_WITH_KEY_NAME 1583
#define ER_BINLOG_PURGE_EMFILE 1584
#define ER_EVENT_CANNOT_CREATE_IN_THE_PAST 1585
#define ER_EVENT_CANNOT_ALTER_IN_THE_PAST 1586
#define ER_SLAVE_INCIDENT 1587
#define ER_NO_PARTITION_FOR_GIVEN_VALUE_SILENT 1588
#define ER_BINLOG_UNSAFE_STATEMENT 1589
#define ER_SLAVE_FATAL_ERROR 1590
#define ER_SLAVE_RELAY_LOG_READ_FAILURE 1591
#define ER_SLAVE_RELAY_LOG_WRITE_FAILURE 1592
#define ER_SLAVE_CREATE_EVENT_FAILURE 1593
#define ER_SLAVE_MASTER_COM_FAILURE 1594
#define ER_BINLOG_LOGGING_IMPOSSIBLE 1595
#define ER_VIEW_NO_CREATION_CTX 1596
#define ER_VIEW_INVALID_CREATION_CTX 1597
#define ER_SR_INVALID_CREATION_CTX 1598
#define ER_TRG_CORRUPTED_FILE 1599
#define ER_TRG_NO_CREATION_CTX 1600
#define ER_TRG_INVALID_CREATION_CTX 1601
#define ER_EVENT_INVALID_CREATION_CTX 1602
#define ER_TRG_CANT_OPEN_TABLE 1603
#define ER_ERROR_LAST 1603
