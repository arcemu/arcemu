...
sudo docker volume create arcemu_logon_configs
sudo docker volume create arcemu_logon_logs
sudo docker volume create arcemu_world_configs
...
Copy logon.conf to /var/lib/docker/volumes/arcemu_logon_configs/_data
Copy optional.conf, realms.conf, world.conf to /var/lib/docker/volumes/arcemu_world_configs/_data
