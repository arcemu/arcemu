...
8. Run the image:
docker run --network host -t -v arcemu_world_etc:/srv/arcemu_world/etc:ro -v arcemu_world_logs:/srv/arcemu_world/log -v arcemu_world_DBC:/srv/arcemu_world/DBC -v arcemu_world_maps:/srv/arcemu_world/maps arcemu_world
