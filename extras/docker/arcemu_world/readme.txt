...
docker volume create arcemu_world_configs
...
6. Copy the config files to /var/lib/docker/volumes/arcemu_world_configs/_data
...
9. Run the image:
docker run --network host -ti -v arcemu_world_configs:/srv/arcemu_world/configs:ro -v arcemu_world_logs:/srv/arcemu_world/log -v arcemu_world_DBC:/srv/arcemu_world/DBC -v arcemu_world_maps:/srv/arcemu_world/maps -v arcemu_world_scripts:/srv/arcemu_world/scripts arcemu_world
