...
MACRO(_PCH_GET_TARGET_COMPILE_FLAGS _cflags  _header_name _pch_path _dowarn)
  ...
  IF( CMAKE_COMPILER_IS_GNUCXX )
  # for use with distcc and gcc>4.0.1 if preprocessed files areaccessible
...
# Ensure same directory! Required by gcc
  IF(NOT ${CMAKE_CURRENT_SOURCE_DIR} STREQUAL ${CMAKE_CURRENT_BINARY_DIR})
    ...
    ADD_CUSTOM_COMMAND(OUTPUT       ${CMAKE_CURRENT_BINARY_DIR}/${_name} COMMAND ${CMAKE_COMMAND} -E copy ${CMAKE_CURRENT_SOURCE_DIR}/${_input} ${CMAKE_CURRENT_BINARY_DIR}/${_name} DEPENDS ${_input})
  ENDIF( NOT ${CMAKE_CURRENT_SOURCE_DIR} STREQUAL ${CMAKE_CURRENT_BINARY_DIR} )

#message("_command  ${_input} ${_output}")
  _PCH_GET_COMPILE_COMMAND(_command  ${CMAKE_CURRENT_BINARY_DIR}/${_name} ${_output} )

  ADD_CUSTOM_COMMAND(OUTPUT ${_output} COMMAND ${_command} IMPLICIT_DEPENDS CXX ${CMAKE_CURRENT_BINARY_DIR}/${_name})
